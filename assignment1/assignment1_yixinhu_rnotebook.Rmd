...
cf_income <- dist_comb %>% 
  ggplot(aes(x=income)) +
  geom_histogram(data=close_df,color="blue") +
  geom_histogram(data=far_df,color="red")
...
close_df %>% 
  ggplot(aes(x=income)) +
  geom_histogram() + 
  ggtitle("Close to school income distributions")

far_df %>% 
  ggplot(aes(x=income)) +
  geom_histogram() + 
  ggtitle("Far from school income distributions")
